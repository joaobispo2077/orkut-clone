...
// Menu
// ================================================================================================================
export function OrkutMenu({ githubUser }) {
  ...
  return (
    <OrkutMenu.Wrapper isMenuOpen={isMenuOpen}>
      ...
      <OrkutMenuProfileSidebar githubUser={githubUser} />
    </OrkutMenu.Wrapper>
  )
}
OrkutMenu.Wrapper = styled.header`
  width: 100%;
...
function OrkutMenuProfileSidebar({ githubUser }) {
  return (
...
// OrkutProfileSidebarMenuDefault
// ================================================================================================================
export function OrkutProfileSidebarMenuDefault() {
  return (
...
OrkutProfileSidebarMenuDefault.Wrapper = styled.div`
  a {
    font-size: 12px;
    color: #2E7BB4;
    margin-bottom: 16px;
